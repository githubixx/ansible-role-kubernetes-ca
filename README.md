...
# etcd clients (like "Traefik" and "Cilium" e.g.).
ca_etcd_csr_cn: "Etcd"
...
# In general the role will include all IP's, hostnames and FQDN that are needed
...
# some default Kubernetes hostname's that are available by default if
# "CoreDNS" is deployed.
